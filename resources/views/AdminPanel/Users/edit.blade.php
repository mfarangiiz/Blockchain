                        ...
                        <div class="flex-auto p-6">
                            <form action="{{ route('User.update',$data->id) }}" method="POST">
                                ...
                                <div id="pass2" class="mb-4 ppearance-none rounded-lg border border-solid border-gray-300">
                                    <input type="password" id="passwordcon" onkeyup="check1('passwordcon');" onclick="check1('passwordcon');" name="password_confirmation" placeholder="Confirim Password" style="width: 87%" class="focus:shadow-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease  appearance-none rounded-lg border-solid border-gray-300 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                ...
                                <div class="text-center">
                                    <input type="submit" value="O'zgartirish" class="inline-block w-full px-5 py-2.5 mt-6 mb-2 font-bold text-center text-white align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer active:opacity-85 hover:-translate-y-px hover:shadow-xs leading-normal text-sm ease-in tracking-tight-rem shadow-md bg-150 bg-x-25 bg-gradient-to-tl from-zinc-800 to-zinc-700 hover:border-slate-700 hover:bg-slate-700 hover:text-white">
                                </div>
                            </form>
                        </div>
                    </div>
