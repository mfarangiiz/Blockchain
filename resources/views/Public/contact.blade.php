...
<body class="main-layout inner_page">
    ...
    <div id="mySidepanel" class="sidepanel">
        ...
        <a class="active" href="contact">Murojaat</a>
    </div>
    <!-- header -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class=" col-md-10 offset-md-1">
                    <form action="{{route('Message.store')}}" method="post" class="main_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 ">
                                <input class="contactus" placeholder="Ismingiz" type="text" name="name" required>
                            </div>
                            <div class="col-md-6">
                                <input class="contactus" placeholder="Email" type="email" name="email" required>
                            </div>
                            <div class="col-md-6">
                                <input class="contactus" placeholder="Sarlavha" type="text" name=subject required>
                            </div>
                            <div class="col-md-6">
                                <textarea class="textarea" placeholder="Xabar" type="text" name="message" required></textarea>
                            </div>
                            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="Informa conta ">
                            <h3>Bog'lanish</h3>
                            <ul>
                                <li> <a href="Javascript:void(0) "><i class="fa fa-phone " aria-hidden="true "></i>Tel raqam: +998 99 123 45 67
                                </a>
                                </li>
